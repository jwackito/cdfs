from math import sin, cos, sqrt, acos, asin, atan2, pi, atan, degrees, pow, degrees, radians
from scipy import mat, cos, sin, arctan, sqrt, pi, arctan2, deg2rad, rad2deg
#from https://code.google.com/p/pysatel/source/browse/trunk/coord.py?r=22 import this_file
#Thanks <<Copyright (C) 2010 David Parunakian>>
